...
| 仓库 | 语言 | 依赖 | 测试 |
|---|---|---|---|
| [DingTalk-Real-AI/dingtalk-channel-sdk-go](https://github.com/DingTalk-Real-AI/dingtalk-channel-sdk-go) | Go 1.22+ | gorilla/websocket | 19 tests（-race 干净） |
...
每仓含：完整源码、单测、`SPEC.zh-CN.md`（四语言统一契约）、流式 echo 示例、**livecheck 真实联调程序**、README、MIT LICENSE。
...
---
License：MIT ｜ 契约：各仓 `SPEC.zh-CN.md` ｜ 版本：v0.1.0（2026-08）
